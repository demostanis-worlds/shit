...
var HP = 6
var coord = 6
var HP1 = 798273498723483479823749283748927483
...
var radarleader = 3;
var radarclan = 3;
var animalcolor = "#0017FF"
var killercolor = "#000000"
var leadercolor = "#E0FF00"
var clancolor = "#00FF13"
var Healthbarcolor = "#8ecc51"
var Healthbarcolor2 = "#cc5151"
...
<div id="simpleModal" class="modal">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h2 style="font-size: 17px;">Radar Menu</h2>
        </div>
...
<fieldset>
          <legend>radar</legend>
          <label class="HP">Show HP<input type="checkbox" id="HP"><span class="checkmarkx"></span></label>
          <label class="coord">Show coordinates<input type="checkbox" id="coord"><span class="checkmarkx"></span></label>
        </fieldset>

<fieldset>
          <legend>animal radar</legend>
          <label class="animalradar">Blue<input type="checkbox" id="animalblue"><span class="checkmarkx"></span></label>
          <label class="animalradar">Red <input type="checkbox" id="animalred"><span class="checkmarkx"></span></label>
          <label class="animalradar">green<input type="checkbox" id="animalgreen"><span class="checkmarkx"></span></label>
          <label class="animalradar">yellow<input type="checkbox" id="animalyellow"><span class="checkmarkx"></span></label>
          <label class="animalradar">white<input type="checkbox" id="animalwhite"><span class="checkmarkx"></span></label>
          <label class="animalradar">black<input type="checkbox" id="animalblack"><span class="checkmarkx"></span></label>
          <label class="animalradar">orange<input type="checkbox" id="animalorange"><span class="checkmarkx"></span></label>
        </fieldset>

<fieldset>
          <legend>enemy radar</legend>
          <label class="enemyradar">Blue<input type="checkbox" id="enemyblue"><span class="checkmarkx"></span></label>
          <label class="enemyradar">Red <input type="checkbox" id="enemyred"><span class="checkmarkx"></span></label>
          <label class="enemyradar">green<input type="checkbox" id="enemygreen"><span class="checkmarkx"></span></label>
          <label class="enemyradar">yellow<input type="checkbox" id="enemyyellow"><span class="checkmarkx"></span></label>
          <label class="enemyradar">white<input type="checkbox" id="enemywhite"><span class="checkmarkx"></span></label>
          <label class="enemyradar">black<input type="checkbox" id="enemyblack"><span class="checkmarkx"></span></label>
          <label class="enemyradar">orange<input type="checkbox" id="enemyorange"><span class="checkmarkx"></span></label>
        </fieldset>

<fieldset>
          <legend>clan radar</legend>
          <label class="clanradar">Blue<input type="checkbox" id="clanblue"><span class="checkmarkx"></span></label>
          <label class="clanradar">Red <input type="checkbox" id="clanred"><span class="checkmarkx"></span></label>
          <label class="clanradar">green<input type="checkbox" id="clangreen"><span class="checkmarkx"></span></label>
          <label class="clanradar">yellow<input type="checkbox" id="clanyellow"><span class="checkmarkx"></span></label>
          <label class="clanradar">white<input type="checkbox" id="clanwhite"><span class="checkmarkx"></span></label>
          <label class="clanradar">black<input type="checkbox" id="clanblack"><span class="checkmarkx"></span></label>
          <label class="clanradar">orange<input type="checkbox" id="clanorange"><span class="checkmarkx"></span></label>
        </fieldset>

<fieldset>
          <legend>Leader radar</legend>
          <label class="leaderradar">Blue<input type="checkbox" id="leaderblue"><span class="checkmarkx"></span></label>
          <label class="leaderradar">Red <input type="checkbox" id="leaderred"><span class="checkmarkx"></span></label>
          <label class="leaderradar">green<input type="checkbox" id="leadergreen"><span class="checkmarkx"></span></label>
          <label class="leaderradar">yellow<input type="checkbox" id="leaderyellow"><span class="checkmarkx"></span></label>
          <label class="leaderradar">white<input type="checkbox" id="leaderwhite"><span class="checkmarkx"></span></label>
          <label class="leaderradar">black<input type="checkbox" id="leaderblack"><span class="checkmarkx"></span></label>
          <label class="leaderradar">orange<input type="checkbox" id="leaderorange"><span class="checkmarkx"></span></label>
        </fieldset>

<fieldset>
          <legend>Healthbar color (your team)</legend>
          <label class="healthcolor">Blue<input type="checkbox" id="healthblue"><span class="checkmarkx"></span></label>
          <label class="healthcolor">Red <input type="checkbox" id="healthred"><span class="checkmarkx"></span></label>
          <label class="healthcolor">yellow<input type="checkbox" id="healthyellow"><span class="checkmarkx"></span></label>
          <label class="healthcolor">white<input type="checkbox" id="healthwhite"><span class="checkmarkx"></span></label>
          <label class="healthcolor">black<input type="checkbox" id="healthblack"><span class="checkmarkx"></span></label>
          <label class="healthcolor">orange<input type="checkbox" id="healthorange"><span class="checkmarkx"></span></label>
        </fieldset>

<fieldset>
          <legend>Healthbar color (enemy)</legend>
          <label class="healthcolor">Blue<input type="checkbox" id="healthblue1"><span class="checkmarkx"></span></label>
          <label class="healthcolor">Green <input type="checkbox" id="healthred1"><span class="checkmarkx"></span></label>
          <label class="healthcolor">yellow<input type="checkbox" id="healthyellow1"><span class="checkmarkx"></span></label>
          <label class="healthcolor">white<input type="checkbox" id="healthwhite1"><span class="checkmarkx"></span></label>
          <label class="healthcolor">black<input type="checkbox" id="healthblack1"><span class="checkmarkx"></span></label>
          <label class="healthcolor">orange<input type="checkbox" id="healthorange1"><span class="checkmarkx"></span></label>
        </fieldset>
<fieldset>
          <legend>Name color</legend>
          <label class="namecoloryes">Blue<input type="checkbox" id="name1"><span class="checkmarkx"></span></label>
          <label class="namecoloryes">Red <input type="checkbox" id="name2"><span class="checkmarkx"></span></label>
          <label class="namecoloryes">green<input type="checkbox" id="name3"><span class="checkmarkx"></span></label>
          <label class="namecoloryes">yellow<input type="checkbox" id="name4"><span class="checkmarkx"></span></label>
          <label class="namecoloryes">white<input type="checkbox" id="name5"><span class="checkmarkx"></span></label>
          <label class="namecoloryes">black<input type="checkbox" id="name6"><span class="checkmarkx"></span></label>
          <label class="namecoloryes">orange<input type="checkbox" id="name7"><span class="checkmarkx"></span></label>
        </fieldset>
            </div>
        </div>
        <div class="modal-footer">
            <h3 style="font-size: 17px;">Alpha Mod By Nuro</h3>
        </div>
    </div>
</div>
`
...
var img = "http://moomoo.io/img/hats/hat_0.png"
var img2 = "http://moomoo.io/img/accessories/access_11.png"
...
var newImg = document.createElement("img");
    newImg.src = "https://i.ya-webdesign.com/images/vector-radar-psd-2.png"
...
menu.innerHTML = `
    <div class="i-tab-container">
      <div class="i-tab-menu sidebar">
        <a href="https://jabiddle.com/moomod/"><h2 class="i-tab-menu-item">MooMod</h2></a>
        ...
        <button id="mm-controls-menu-item" class="i-tab-menu-item">Hats</button>
        <button id="mm-help-menu-item" class="i-tab-menu-item i-last">Help</button>
      </div>
      <div id="mm-main-menu" class="i-tab-content">
        <h3>Main</h3>
        <label class="i-checkbox-label"><input id="mm-autoHeal" type="checkbox" class="i-checkbox">Auto Heal</label>
        ...
        <label>Auto Chat: <input id="mm-autoChatMessage" type="text" minlength="0" maxlength="30" style="width: 250px;" placeholder="This text will display automatically" class="i-checkbox"></label>
        <fieldset>
      ...
      <div id="mm-offense-menu" class="i-tab-content" style="display: none;">
        ...
        <fieldset>
          ...
          <label class="i-select-label">Hat: <select class="mm-hat-selector" id="mm-offenseHatHammer"><option value="-1" selected="">None</option><option value="45">Shame!</option><option value="51">Moo Cap</option><option value="50">Apple Cap</option><option value="28">Moo Head</option><option value="29">Pig Head</option><option value="30">Fluff Head</option><option value="36">Pandou Head</option><option value="37">Bear Head</option><option value="38">Monkey Head</option><option value="44">Polar Head</option><option value="35">Fez Hat</option><option value="42">Enigma Hat</option><option value="43">Blitz Hat</option><option value="49">Bob XIII Hat</option><option value="8">Bummle Hat</option><option value="2">Straw Hat</option><option value="15">Winter Cap</option><option value="5">Cowboy Hat</option><option value="4">Ranger Hat</option><option value="18">Explorer Hat</option><option value="31">Flipper Hat</option><option value="1">Marksman Cap</option><option value="10">Bush Gear</option><option value="48">Halo</option><option value="6">Soldier Helmet</option><option value="23">Anti Venom Gear</option><option value="13">Medic Gear</option><option value="9">Miners Helmet</option><option value="32">Musketeer Hat</option><option value="7">Bull Helmet</option><option value="22">Emp Helmet</option><option value="12">Booster Hat</option><option value="26">Barbarian Armor</option><option value="21">Plague Mask</option><option value="46">Bull Mask</option><option value="14">Windmill Hat</option><option value="11">Spike Gear</option><option value="53">Turret Gear</option><option value="20">Samurai Armor</option><option value="16">Bushido Armor</option><option value="27">Scavenger Gear</option><option value="40">Tank Gear</option><option value="52">Thief Gear</option></select></label>
      ...
      <div id="mm-support-menu" class="i-tab-content" style="display: none;">
        <h3>Support</h3>
        <label class="i-checkbox-label"><input id="mm-useFastestGear" type="checkbox" class="i-checkbox">Use fastest hat/accessory available</label>
        <label class="i-checkbox-label"><input id="mm-autoFlipperHat" type="checkbox" class="i-checkbox">Auto equip Flipper Hat</label>
        <fieldset id="mm-supportDefaults">
          <legend>Default</legend>
          <label class="i-select-label">Hat: <select class="mm-hat-selector" id="mm-supportHatDefault"><option value="-1" selected="">None</option><option value="45">Shame!</option><option value="51">Moo Cap</option><option value="50">Apple Cap</option><option value="28">Moo Head</option><option value="29">Pig Head</option><option value="30">Fluff Head</option><option value="36">Pandou Head</option><option value="37">Bear Head</option><option value="38">Monkey Head</option><option value="44">Polar Head</option><option value="35">Fez Hat</option><option value="42">Enigma Hat</option><option value="43">Blitz Hat</option><option value="49">Bob XIII Hat</option><option value="8">Bummle Hat</option><option value="2">Straw Hat</option><option value="15">Winter Cap</option><option value="5">Cowboy Hat</option><option value="4">Ranger Hat</option><option value="18">Explorer Hat</option><option value="31">Flipper Hat</option><option value="1">Marksman Cap</option><option value="10">Bush Gear</option><option value="48">Halo</option><option value="6">Soldier Helmet</option><option value="23">Anti Venom Gear</option><option value="13">Medic Gear</option><option value="9">Miners Helmet</option><option value="32">Musketeer Hat</option><option value="7">Bull Helmet</option><option value="22">Emp Helmet</option><option value="12">Booster Hat</option><option value="26">Barbarian Armor</option><option value="21">Plague Mask</option><option value="46">Bull Mask</option><option value="14">Windmill Hat</option><option value="11">Spike Gear</option><option value="53">Turret Gear</option><option value="20">Samurai Armor</option><option value="16">Bushido Armor</option><option value="27">Scavenger Gear</option><option value="40">Tank Gear</option><option value="52">Thief Gear</option></select></label>
        ...
        <fieldset>
          <legend>Clicking</legend>
          <label class="i-select-label">Hat: <select class="mm-hat-selector" id="mm-supportHatClicking"><option value="-1" selected="">None</option><option value="45">Shame!</option><option value="51">Moo Cap</option><option value="50">Apple Cap</option><option value="28">Moo Head</option><option value="29">Pig Head</option><option value="30">Fluff Head</option><option value="36">Pandou Head</option><option value="37">Bear Head</option><option value="38">Monkey Head</option><option value="44">Polar Head</option><option value="35">Fez Hat</option><option value="42">Enigma Hat</option><option value="43">Blitz Hat</option><option value="49">Bob XIII Hat</option><option value="8">Bummle Hat</option><option value="2">Straw Hat</option><option value="15">Winter Cap</option><option value="5">Cowboy Hat</option><option value="4">Ranger Hat</option><option value="18">Explorer Hat</option><option value="31">Flipper Hat</option><option value="1">Marksman Cap</option><option value="10">Bush Gear</option><option value="48">Halo</option><option value="6">Soldier Helmet</option><option value="23">Anti Venom Gear</option><option value="13">Medic Gear</option><option value="9">Miners Helmet</option><option value="32">Musketeer Hat</option><option value="7">Bull Helmet</option><option value="22">Emp Helmet</option><option value="12">Booster Hat</option><option value="26">Barbarian Armor</option><option value="21">Plague Mask</option><option value="46">Bull Mask</option><option value="14">Windmill Hat</option><option value="11">Spike Gear</option><option value="53">Turret Gear</option><option value="20">Samurai Armor</option><option value="16">Bushido Armor</option><option value="27">Scavenger Gear</option><option value="40">Tank Gear</option><option value="52">Thief Gear</option></select></label>
      ...
      <div id="mm-map-menu" class="i-tab-content" style="display: none;">
        <h3>Map</h3>
        <label class="i-checkbox-label"><input id="mm-showMapBackground" type="checkbox" class="i-checkbox">Use biome map</label>
        <label class="i-checkbox-label"><input id="mm-showPlayerMarkers" type="checkbox" class="i-checkbox">Show my markers</label>
        <label class="i-checkbox-label"><input id="mm-showEnemyMarkers" type="checkbox" class="i-checkbox">Show enemy markers</label>
        <label class="i-checkbox-label"><input id="mm-keepMarkersOnDeath" type="checkbox" class="i-checkbox">Keep markers on death</label>
        <div class="i-palomita">Para mi palomita - by <a href="https://jabiddle.com/">jabiddle</a></div>
      </div>
      <div id="mm-controls-menu" class="i-tab-content" style="display: none;">
        <h3>Controls</h3>
        <label>Open MooMod Menu: <button id="mm-keybind-openMenu" class="i-button i-bold i-right i-inline i-keybind">ESCAPE</button></label>
        <br>
        <label class="i-checkbox-label"><input id="mm-betterControls" type="checkbox" class="i-checkbox">Custom Controls</label>
        <fieldset id="i-keybinds">
          <legend>Nuro Mods</legend>
        </fieldset>
      </div>
      <div id="mm-help-menu" class="i-tab-content" style="display: none;">
        <h3>Help</h3>
        <p>The Basics: Hats and accessories have three priority levels: Offense, Defense, and Support. Offense is always preffered and Defense will equip before support. But when does each priority get activated?</p>
        <ul>
          <li><strong>Offense:</strong> Equips when you use a weapon (click) with an enemy in attacking range. (Bows might not work atm)</li>
        ...
        <div id="i-keybind-listener-container">
          <div id="i-keybind-listener">
            <span id="i-keybind-listener-title"></span>
            <span id="i-keybind-listener-value" class="i-text-centered"></span>
            <span id="i-keybind-listener-instructions">Press any key...</span>
            <div class="i-center-contents">
              <button id="i-keybind-listener-save" class="i-button i-confirm">Save</button>
              <button id="i-keybind-listener-cancel" class="i-button i-cancel">Cancel</button>
            </div>
          </div>
      </div>
    </div>
...
button.textContent = "Open Alpha Menu";
...
var EnemyTracer = "#ff0000"
var KillerTracer = "#ff0000"
var LeaderTracer = "#ff0000"
            ...
            B = Date.now(), P = B - q, q = B,
                    ...
                    for (be.globalAlpha = 1, be.fillStyle = "rgba(0, 0, 70, 0.35)", be.fillRect(0, 0, oe, ce), be.strokeStyle = rt, a = 0; a < W.length + Y.length; ++a)
                       if ((_ = W[a] || Y[a - W.length]).visible && (10 != _.skinIndex || _ ==
						...
						var w = (_.team ? "〖" + _.team + "〗" : "") + (_.isPlayer&&_.sid? "༺ " : "") + (_.name + " ༻"|| "");
							if ("" != w) {
								if (be.font = (_.nameScale || 25) + "px Hammersmith One", be.fillStyle = namecolor ,
									 be.textBaseline = "middle", be.textAlign = "center", be.lineWidth =
									_.nameScale ? 11 : 8, be.lineJoin = "round", be.strokeStyle = "black", be.strokeText(w, _.x -
                            ...
                            window.w = R.weapons;
                            var HP1234 = ("HP: " + _.health + "/" + _.maxHealth);
                            var cord1234 = ("X : " + Math.round(_.x) + "  |  Y : " + Math.round(_.y));
                            //var info121 = ( " reloadz: " + _.reloads.weaponIndex + " age: " + _.age + " weaponIndex: " + _.weaponIndex + " dmg: " +_.dmgOverTime)
                ...
                var color = '#' + r1213.toString(16) + g1213.toString(16) + b1213.toString(16);
                           (be.textAlign = "center",
                            ...
                            be.lineWidth = HP,
                            be.strokeText(HP1234 ,_.x - f,_.y - d + _.scale + o.nameY+(HP1)),
                            be.fillText(HP1234 ,_.x - f,_.y - d + _.scale + o.nameY+(HP1))
                            )
                            if(R.isPlayer) {
                            be.textAlign = "center",
                            be.fillStyle = "#0017FF",
                            ...
                            be.strokeStyle = "black",
                            be.lineWidth = coord,
                            be.strokeText(cord1234 ,_.x - f,_.y - d + _.scale + o.nameY+(coord1)),
                            be.fillText(cord1234 ,_.x - f,_.y - d + _.scale + o.nameY+(coord1))
                            };
                            if(R) {
                           // be.textAlign = "center",
                           // be.fillStyle = "#cc5500",
                           ...
                           // be.strokeStyle = "black",
                           // be.lineWidth = 6,
                           // be.strokeText(info121 ,_.x - f,_.y - d + _.scale + o.nameY+(86)),
                           // be.fillText(info121 ,_.x - f,_.y - d + _.scale + o.nameY+(86))
                            };
                            if(_.isPlayer&&_!=R&&_.team&&_.team==R.team){//tribe tracers
                            be.lineCap = "round";
                            be.strokeStyle = clancolor;
                            be.lineWidth = radarclan;
                            be.beginPath();
                          ...
                          if(_.isPlayer&&_!=R&&(_.team!=R.team||!_.team)){//enemy tracers
                            be.lineCap = "round";
                            be.strokeStyle = EnemyTracer;
                            be.lineWidth = radarenemy;
                            be.beginPath();
                            be.moveTo(R.x-f, R.y-d);
                            be.lineTo(_.x-f, _.y-d);
                            be.stroke();
                          ...
                          if(!_.isPlayer){//animal tracers
                            be.lineCap = "round";
                            be.strokeStyle = animalcolor;
                            be.lineWidth = radaranimal;
                            be.beginPath();
                            be.moveTo(R.x-f, R.y-d);
                            be.lineTo(_.x-f, _.y-d);
                            be.stroke();
                            ...
                            be.lineCap = "round";
                            be.strokeStyle = leadercolor;
                            be.lineWidth = radarleader;
                            be.beginPath();
                            be.moveTo(R.x-f, R.y-d);
                            be.lineTo(_.x-f, _.y-d);
                            be.stroke();
                            ...
                            if(_.isPlayer&&_.skull){//best killer tracers
                            be.lineCap = "round";
                            be.strokeStyle = killercolor;
                            be.lineWidth = radartopkiller;
                            be.beginPath();
                            be.moveTo(R.x-f, R.y-d);
                            be.lineTo(_.x-f, _.y-d);
                            be.stroke();
                            ...
                            _.health > 0 && (o.healthBarWidth, be.fillStyle = rt, be.roundRect(_.x - f - o.healthBarWidth - o.healthBarPad, _.y - d + _.scale + o.nameY, 2 * o.healthBarWidth + 2 * o.healthBarPad, 17, 8), be.fill(), be.fillStyle = _ == R || _.team && _.team == R.team ? Healthbarcolor : Healthbarcolor2, be.roundRect(_.x - f - o.healthBarWidth, _.y - d + _.scale + o.nameY + o.healthBarPad, 2 * o.healthBarWidth * (_.health / _.maxHealth), 17 - 2 * o.healthBarPad, 7), be.fill())
...
var aaa = document.querySelector("#HP")
...
aaa.addEventListener('change', function() {
    if (this.checked) {
        ...
        HP = 0
        HP1 = 476124978638947623742
        doNewSend(["ch", ["HP : OFF"]]);

    }
})
var aaa2 = document.querySelector("#coord")

aaa2.addEventListener('change', function() {
    if (this.checked) {
        coord = 6
        coord1 = 60
        doNewSend(["ch", ["coordinates : ON"]]);
    } else {
                coord = 0
        coord1 = 376491278638974692374692378469237
        doNewSend(["ch", ["coordinates : OFF"]]);

    }
})
var aaa3 = document.querySelector("#animalblue")
aaa3.addEventListener('change', function() {
    if (this.checked) {
 animalcolor = "#0017FF"
        doNewSend(["ch", ["Animal radar : Blue"]]);
    }
})
var aaa4 = document.querySelector("#animalred")
aaa4.addEventListener('change', function() {
    if (this.checked) {
 animalcolor = "#FF0000"
        doNewSend(["ch", ["Animal radar : Red"]]);
    }
})
var aaa5 = document.querySelector("#animalgreen")
aaa5.addEventListener('change', function() {
    if (this.checked) {
 animalcolor = "#00FF1B"
        doNewSend(["ch", ["Animal radar : Green"]]);
    }
})
var aaa6 = document.querySelector("#animalyellow")
aaa6.addEventListener('change', function() {
    if (this.checked) {
 animalcolor = "#FFFF00"
        doNewSend(["ch", ["Animal radar : Yellow"]]);
    }
})
var aaa7 = document.querySelector("#animalwhite")
aaa7.addEventListener('change', function() {
    if (this.checked) {
 animalcolor = "#FFFFFF"
        doNewSend(["ch", ["Animal radar : White"]]);
    }
})
var aaa8 = document.querySelector("#animalblack")
aaa8.addEventListener('change', function() {
    if (this.checked) {
 animalcolor = "#000000"
        doNewSend(["ch", ["Animal radar : Black"]]);
    }
})
var aaa9 = document.querySelector("#animalorange")
aaa9.addEventListener('change', function() {
    if (this.checked) {
 animalcolor = "#FFC500"
        doNewSend(["ch", ["Animal radar : Orange"]]);
    }
})
var aaa10 = document.querySelector("#enemyblue")
aaa10.addEventListener('change', function() {
    if (this.checked) {
 EnemyTracer = "#0017FF"
        doNewSend(["ch", ["Enemy radar : Blue"]]);
    }
})
var aaa11 = document.querySelector("#enemyred")
aaa11.addEventListener('change', function() {
    if (this.checked) {
 EnemyTracer = "#FF0000"
        doNewSend(["ch", ["Enemy radar : Red"]]);
    }
})
var aaa12 = document.querySelector("#enemygreen")
aaa12.addEventListener('change', function() {
    if (this.checked) {
 EnemyTracer = "#00FF1B"
        doNewSend(["ch", ["Enemy radar : Green"]]);
    }
})
var aaa13 = document.querySelector("#enemyyellow")
aaa13.addEventListener('change', function() {
    if (this.checked) {
 EnemyTracer = "#FFFF00"
        doNewSend(["ch", ["Enemy radar : Yellow"]]);
    }
})
var aaa14 = document.querySelector("#enemywhite")
aaa14.addEventListener('change', function() {
    if (this.checked) {
 EnemyTracer = "#FFFFFF"
        doNewSend(["ch", ["Enemy radar : White"]]);
    }
})
var aaa15 = document.querySelector("#enemyblack")
aaa15.addEventListener('change', function() {
    if (this.checked) {
 EnemyTracer = "#000000"
        doNewSend(["ch", ["Enemy radar : Black"]]);
    }
})
var aaa16 = document.querySelector("#enemyorange")
aaa16.addEventListener('change', function() {
    if (this.checked) {
 EnemyTracer = "#FFC500"
        doNewSend(["ch", ["Enemy radar : Orange"]]);
    }
})
/////////////////////////////////////////////////////////////

var aaa17 = document.querySelector("#clanblue")
aaa17.addEventListener('change', function() {
    if (this.checked) {
 clancolor = "#0017FF"
        doNewSend(["ch", ["Clan radar : Blue"]]);
    }
})
var aaa18 = document.querySelector("#clanred")
aaa18.addEventListener('change', function() {
    if (this.checked) {
 clancolor = "#FF0000"
        doNewSend(["ch", ["Clan radar : Red"]]);
    }
})
var aaa19 = document.querySelector("#clangreen")
aaa19.addEventListener('change', function() {
    if (this.checked) {
 clancolor = "#00FF1B"
        doNewSend(["ch", ["Clan radar : Green"]]);
    }
})
var aaa20 = document.querySelector("#clanyellow")
aaa20.addEventListener('change', function() {
    if (this.checked) {
 clancolor = "#FFFF00"
        doNewSend(["ch", ["Clan radar : Yellow"]]);
    }
})
var aaa21 = document.querySelector("#clanwhite")
aaa21.addEventListener('change', function() {
    if (this.checked) {
 clancolor = "#FFFFFF"
        doNewSend(["ch", ["Clan radar : White"]]);
    }
})
var aaa22 = document.querySelector("#clanblack")
aaa22.addEventListener('change', function() {
    if (this.checked) {
 clancolor = "#000000"
        doNewSend(["ch", ["Clan radar : Black"]]);
    }
})
var aaa23 = document.querySelector("#clanorange")
aaa23.addEventListener('change', function() {
    if (this.checked) {
 clancolor = "#FFC500"
        doNewSend(["ch", ["Clan radar : Orange"]]);
    }
})
